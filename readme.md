# Inaugural Engine, Audio Module

This is the module for the Soliloquy Inaugural Engine which supports the use of Audio.

## Getting Started

To use the Inaugural Audio Module in your Soliloquy game, ensure that you have set up your game as a Maven project, and that the following sections are present in your POM:
...
```
    <dependency>
    	...
    	<artifactId>inaugural.soliloquy.audio</artifactId>
